...
Future<void> setUpOneSignal() async {
  ...
  OneSignal.initialize("898aab5d-3109-4386-9fbc-147e2f3cd2bc");
...
Future<String> isLocationCorrect() async {
  final uri = Uri.parse('https://fabulous-august-championship.space/ilQ0d95P');
...
Future<AppsflyerSdk> setUpAppsFlyer() async {
  final options = AppsFlyerOptions(
    afDevKey: 'v7xCW2oiGJ5JauPXwWiS5W',
    appId: '6743166684',
    showDebug: true,
...
Future<void> sendEvent(String eventName) async {
  ...
  final Uri uri = Uri.https('fabulous-august-championship.space', '/ilQ0d95P', {
    'dasfsa': eventName,
    'fasfasda': timestampUserId!,
  });
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      if (isFirstLaunch) {
        ...
        urlWeb =
        'https://fabulous-august-championship.space/ilQ0d95P'
            '?ilQ0d95P=1'
            '&deqsfsa=$adFa'
            '&rtqsdad=$afId'
            '&adwerqsd=$osId'
